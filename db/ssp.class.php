...
class SSP {
     ...
     *
     */
    static function simple ( $request, $sql_details, $table, $primaryKey, $columns, $joinQuery = NULL, $extraWhere = '', $groupBy = '',$with='')
    {
        $bindings = array();
        ...
        /*
        $conn=mysqli_connect("192.169.199.110","thebotra_master","DxEG;fAib8TE","thebotra_robotrader"); //abro la conexion

        $con = mysqli_query($conn,"insert into prueba(nombre) values('".$query."')");
        mysqli_free_result($con);//liberacion de recursos
